...
namespace CustomValidation
{
    ...
    public class RequiredFieldValidator : BaseValidator
    {
        ...
        protected override bool EvaluateIsValid()
        {
            ...
            if (controlValue == null || controlValue.ToString() == "-1" || controlValue.ToString().Trim() == "") return false;
            string initialValue;
            if (_initialValue == null) initialValue = "";
            else initialValue = _initialValue.Trim();
            return (controlValue.ToString() != initialValue);
        }
    }
    #endregion
    ...
    public abstract class BaseContainerValidator : Component
    {
        ...
        public void Validate()
        {
            ...
            if (firstInTabOrder != null)
            {
                System.Windows.Forms.TabPage tabPage = firstInTabOrder.ControlToValidate.Parent as System.Windows.Forms.TabPage;
                if (tabPage != null)
