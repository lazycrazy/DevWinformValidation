...
namespace CustomValidation
{
    ...
    public class ValidationSummaryForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.closeButton.Location = new System.Drawing.Point(258, 202);
            ...
            this.validationErrorsList.Size = new System.Drawing.Size(338, 174);
            ...
            this.lblErrorMessage.Size = new System.Drawing.Size(335, 13);
            ...
            this.label1.Text = "双击错误信息到相关的编辑控件";
            // 
        ...
        public void BaseValidator_Validated(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //remove validator
                foreach (object obj in this.validationErrorsList.Items)
                {
                    if ((obj as BaseValidator) != validator && (obj as BaseValidator).ControlToValidate == validator.ControlToValidate)
                    {
                        removeObj.Add(obj);
                    }
                }
                foreach (object obj in removeObj)
                    this.validationErrorsList.Items.Remove(obj);
        ...
        private void ValidationSummaryForm_Load(object sender, System.EventArgs e)
        {
            ...
            if (this.Owner != null)
            {
                ...
                {
                    this.Top = this.Owner.MdiParent.Bottom - this.Height - 25;
                    this.Left = this.Owner.MdiParent.Right - this.Width - 4;
                }
                else
                {
